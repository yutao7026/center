...
<head>
	...
	<script type="text/javascript">
		function check(flag){
			if(flag == 'search'){
				form1.action = "${ctx}/system/log/log";
		...
		<div class="panel panel-default" style="width: 100%;padding: 10px;">
			<table class="table">
				<tr valign="middle">
					...
					<td width="100px;" style="vertical-align: middle;"><input type="text" name="name" value="${log.name}" style="width: 140px;height: 25px;" class="form-control"></td>
					<td class="control-label" width="90px;" align="right" style="vertical-align: middle;">日志内容:</td>
					<td width="100px;" style="vertical-align: middle;"><input type="text" name="text" value="${log.text}" style="width: 140px;height: 25px;" class="form-control"></td>
