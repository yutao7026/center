	...
	<div style="width: 100%;" align="center">
		<div class="breadcrumbholder module" style="width: 90%;">
			<div id="breadcrumb" class="breadcrumb module" style="width: 100%;height: 33px;">
				<ul>
					...
					<li><a href="${ctx}/support" style="width: 60px;font-size: 12px;">技术支持</a></li>
					<li><span style="width: 30px;font-size: 12px;">编辑</span></li>
				</ul>
			</div>
		</div>
		<br />
		<form id="inputForm" name="inputForm" action="${ctx}/support/${action}" method="post" class="form-horizontal">
		...
		<div id="message" style="width: 90%;display: none;"><a class="close" href="#">×</a><span id="msgText"></span></div>
			<div class="panel panel-default" style="width: 90%;">
				<div class="panel-heading"><strong>技术支持</strong></div>
				<input type="hidden" id="id" name="id" value="${support.id}"/>
				<table class="table">
					<tr>
						<td class="control-label" width="45%;" style="vertical-align: middle;">标题:</td>
						<td width="130px" style="padding-right: 0px;" align="left"><input type="text" id="title" name="title" value="${support.title}" style="width: 200px;height: 25px;" class="form-control"/></td>
					...
					<tr>
						...
						<input type="text" id="description" name="description" value="${support.description}" style="width: 200px;height: 25px;" class="form-control"/>
						<input type="hidden" id="backgroundImageUrl" name="backgroundImageUrl" value="${support.backgroundImageUrl}"/>
						</td>
					...
					<tr>
						...
						<td width="130px" style="padding-right: 0px;" align="left"><input type="text" id="titleEn" name="titleEn" value="${support.titleEn}" style="width: 200px;height: 25px;" class="form-control"/></td>
					...
					<tr>
						...
						<td width="130px" style="padding-right: 0px;" align="left">
						<input type="text" id="descriptionEn" name="descriptionEn" value="${support.descriptionEn}" style="width: 200px;height: 25px;" class="form-control"/>
						</td>
					...
					<tr>
						<td></td>
						<td colspan="2">
							<img id="bgImg" src="${ctx}/file/image?fileName=${support.backgroundImageUrl}" width="200px"/>
						</td>
					</tr>
					<tr>
						...
						<td colspan="2">
							<table class="table" style="width: 200px;margin: 0px;">
								<tr>
									<td align="right" style="vertical-align: middle;padding-left: 0px;">
										<input type="hidden" id="imageUrl1En" name="backgroundImageUrlEn" value="${support.backgroundImageUrlEn}"/>
										<div class="file-box">
					...
					<tr>
						<td></td>
						<td colspan="2">
							<img id="bgImg1En" src="${ctx}/file/image?fileName=${support.backgroundImageUrlEn}" width="200px"/>
						</td>
					</tr>
				</table>
			</div>
			<%	
				if(SessionUtil.checkPurview(session)) {
					...
					<div class="form-actions">
						<button id="submit_btn" class="btn btn-primary" type="submit"><span class="glyphicon glyphicon-save"></span>&nbsp;保存</button>&nbsp; <a id="cancel_btn" class="btn btn-primary" href="${ctx}/support"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;返回</a>
					</div>
					<%
				}
			%>
